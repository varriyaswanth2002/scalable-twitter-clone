<html lang="en" class=""><head>
    ...
    <style class="INLINE_PEN_STYLESHEET_ID">
        :root {
            ...
            --cs-surface-2: #eef4f8;
            --cs-separator: #e8ecf0;
            --cs-on-surface-primary: #000000ab;
            ...
            <div class="layout_wrapper">
                            ...
                            <div class="joke">
                                <div class="joke_wrapper">
                                    <div class="joke_block joke_block--header">
                                        <span class="joke_element joke_element--author-name">Keanuu Reeves</span><span class="joke_element joke_element--author-username">@JohnWick</span>
                                        <div class="joke_element joke_element--author-img"><img src="/static/images/johhny.jpg"></div>
                                    </div>

                                    <button id="create-tweet" type="submit" tabindex="0" fdprocessedid="77d37">
                ...
                <div class="layout_footer">
                    <div class="section section--search">
                        <form class="form form--search-form"><input placeholder="Search dad jokes..." fdprocessedid="jsuclh"></form>
                    </div>
                    <div class="section">
...
</style><div><div class="gf-app"></div></div></template></div><span id="PING_IFRAME_FORM_DETECTION" style="display: none;"></span><span id="PING_IFRAME_FORM_DETECTION" style="display: none;"></span></body></html>