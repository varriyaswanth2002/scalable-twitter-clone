                                ...
                                <div class="joke">
                                    <div class="joke_wrapper">
                                        <div class="joke_block joke_block--header">
                                            ...
                                            <div class="joke_element joke_element--author-img"><img src="/images/profile-image/{{author_id}}.jpeg"></div>
                                        </div>
...
<script>
    ...
    <%-- var tweet_data = {
         data : [
            {"name":"Yaswanth Varri","tweet_text":"Hey this is yaswanth, who wrote this tweet"},
              {"name":"Rohith Varri","tweet_text":"Learn, Inspire, Grow"}
         ]
    }; --%>

    if(!window.lastSeenTweet) window.lastSeenTweet = 999999999
